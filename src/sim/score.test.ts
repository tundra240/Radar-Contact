...
describe('the score', () => {
  it('starts at nothing', () => {
    expect(NO_SCORE).toEqual({ points: 0, landed: 0, lost: 0, transited: 0 })
  })
  ...
  it('neither pays for a transit nor charges for one', () => {
    ...
    const before = { points: 500, landed: 5, lost: 0, transited: 0 }
  ...
  it('leaves the score it was given alone', () => {
    ...
    expect(before).toEqual({ points: 0, landed: 0, lost: 0, transited: 0 })
  })
